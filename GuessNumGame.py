...
def welcome_message():
    ...
    # Function for recruiting guessing
def guess_recrusive(attempts_left):
    #Get user input
    ...
    if guess == secret_number:
        ...
        if attempts_left > 1:
            #Make a recruit cell for another fuess
            guess_recrusive(attempts_left - 1)
        else:
            print(f"\nSorry, you couldn't guess the number. The correct number was {secret_number}.")

#Calling the function
welcome_message()
guess_recrusive(max_attempt)
